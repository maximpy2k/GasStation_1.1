...
namespace GasStation.Mathem.Bubbler
{
    ...
    //        double k = EndRaise >= BegRaise ? _clsBubblerStep.BubblerConst.UpSpeed : -_clsBubblerStep.BubblerConst.DownSpeed;
    ...
    //        switch (_clsBubblerStep.TypeReg)
    //        {
    //            case Regims.TimeInterval:
    ...
    //                break;
    //            case Regims.MaximumSpeed:
    //                CurrSetRaise = _clsBubblerStep.SetupValue;
    //                break;
    //        }

    //        CurrTypeReg = _clsBubblerStep.TypeReg;
