...
{
    public class BaseAcpController : BaseClassController
    {
        ViewModelControllerAcp _viewController;
        public BaseAcpController(string logpath, XmlClassControllerConst contrConst, SerialPort sp, BaseClassViewControllers viewController) : base(logpath, contrConst, sp)
        {
        ...
        /// Результат оцифровки
        /// </summary>
        public double[] AcpValues = new double[8];
