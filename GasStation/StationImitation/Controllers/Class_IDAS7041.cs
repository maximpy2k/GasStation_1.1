...
{
    public class Class_IDAS7041 : ClassBaseController
    {
        /// <summary>
        /// Конструктор класса
        /// </summary>
        /// <param name="addr">Адрес контроллера</param>
        public Class_IDAS7041(int addr) : base(addr)
        {

        }

        ViewModelControllerDio _viewController = new ViewModelControllerDio();
        public Class_IDAS7041(XmlClassControllerConst controllerConst, BaseClassViewControllers viewController) : base(controllerConst, viewController)
        {
