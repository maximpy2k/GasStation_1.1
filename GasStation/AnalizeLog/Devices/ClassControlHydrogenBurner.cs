...
namespace GasStation.Devices
{
    public class ClassControlHydrogenBurner : ClassBaseDevices
    {
        ...
        protected override void NextStepFunc()
        {
            ...
            if (last!=null && curr.StateWater != last.StateWater)
            {
                if (!last.StateWater)
                {
                    ...
                    conJumpArgs.CurrValue = Convert.ToInt32(last.StateWater);
                    conJumpArgs.TextError = "Нет водяного охлаждения";
        ...
        {
            var contr = LstContr[_classHydrogenBurnerStep.HydrogenBurnerConst.DioWaterConst.ContrNum] as ClassController87053;
            return (contr.DioValues[_classHydrogenBurnerStep.HydrogenBurnerConst.DioFireConst.Port]);
        }
